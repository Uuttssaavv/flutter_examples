...
abstract class $ProductStateCopyWith<$Res> {
  ...
  $Res call({List<Product> products, bool isLoading, String errorMessage});
}
...
class _$_ProductState extends _ProductState {
  ...
  @override
  String toString() {
    return 'ProductState(products: $products, isLoading: $isLoading, errorMessage: $errorMessage)';
  }
...
abstract class _ProductState extends ProductState {
  const factory _ProductState(
      ...
      final bool isLoading,
      final String errorMessage}) = _$_ProductState;
